            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Informasi User</h2>
                    ...
                    //menampilkan data pada tabel admin
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td><a href='tampil_edit.php?id=". $row['username'] ."' title='Update Data' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a></td>";
                                        echo "<td><a href='delete.php?id=". $row['username'] ."' title='Delete Data' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a></td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
                            echo "</table>";
